...
// NemoCustomizersGetter has a method to return a NemoCustomizerInterface.
// A group's client should implement this interface.
type NemoCustomizersGetter interface {
	NemoCustomizers(namespace string) NemoCustomizerInterface
}
