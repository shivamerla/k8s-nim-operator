...
func (r *NemoCustomizerReconciler) reconcileNemoCustomizer(ctx context.Context, NemoCustomizer *appsv1alpha1.NemoCustomizer) (ctrl.Result, error) {
	...
	err = validateNemoCustomizer(ctx, NemoCustomizer)
	if err != nil {
		return ctrl.Result{}, err
	}
...
func validateNemoCustomizer(ctx context.Context, NemoCustomizer *appsv1alpha1.NemoCustomizer) error {
	if NemoCustomizer.Spec.Mongodb == nil {
		return fmt.Errorf(" Required field 'Spec.Mongodb' cannot be empty")
	}
	if NemoCustomizer.Spec.ArgoWorkFlows == nil {
		return fmt.Errorf(" Required field 'Spec.ArgoWorkFlows' cannot be empty")
	}
	if NemoCustomizer.Spec.Milvus == nil {
		return fmt.Errorf(" Required field 'Spec.Milvus' cannot be empty")
	}
	if NemoCustomizer.Spec.DataStore == nil {
